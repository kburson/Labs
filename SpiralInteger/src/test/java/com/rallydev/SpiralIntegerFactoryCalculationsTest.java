...
public class SpiralIntegerFactoryCalculationsTest {
	...
	public void topLeftCornerAtOffset_0_is_0() {
		...
		assertEquals(expectedValue,SpiralIntegerFactory.calculateValueAtCorner(cornerOffset,UPPER_LEFT));
	}
	@Test
	...
	public void bottomRightCornerAtOffset_0_is_0() {
		...
		assertEquals(expectedValue,SpiralIntegerFactory.calculateValueAtCorner(cornerOffset,LOWER_RIGHT));
	}
	@Test
